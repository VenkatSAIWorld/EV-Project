...
class Slot1 extends StatefulWidget {
  const Slot1({Key? key}) : super(key: key);

  @override
  State<Slot1> createState() => _Slot1State();
}

class _Slot1State extends State<Slot1> {
...
showAlertDialog(context, val) {
  ...
  return showDialog(
      ...
      builder: (context) {
        ...
        return AlertDialog(
          title: Text("Slot Number $val Has been Booked at ${time.hour}:$mins"),
        );
      });
}
